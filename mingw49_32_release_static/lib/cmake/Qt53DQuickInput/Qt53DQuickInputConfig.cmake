...
set(Qt53DQuickInput_VERSION_STRING 5.6.3)
...
if (NOT TARGET Qt5::3DQuickInput)
    ...
    set(Qt53DQuickInput_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuickInput_install_prefix}/include/Qt3DQuickInput/5.6.3"
        "${_qt53DQuickInput_install_prefix}/include/Qt3DQuickInput/5.6.3/Qt3DQuickInput"
    )
    ...
    foreach(_module_dep ${_Qt53DQuickInput_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.6.3 ${_Qt53DQuickInput_FIND_VERSION_EXACT}
    ...
    if (EXISTS "${_qt53DQuickInput_install_prefix}/lib/libQt53DQuickInputd.a" )
        _populate_3DQuickInput_target_properties(DEBUG "libQt53DQuickInputd.a" "" )
    endif()
