...
set(Qt53DCore_VERSION_STRING 5.6.3)
...
if (NOT TARGET Qt5::3DCore)
    ...
    set(Qt53DCore_PRIVATE_INCLUDE_DIRS
        "${_qt53DCore_install_prefix}/include/Qt3DCore/5.6.3"
        "${_qt53DCore_install_prefix}/include/Qt3DCore/5.6.3/Qt3DCore"
    )
    ...
    foreach(_module_dep ${_Qt53DCore_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.6.3 ${_Qt53DCore_FIND_VERSION_EXACT}
    ...
    if (EXISTS "${_qt53DCore_install_prefix}/lib/libQt53DCored.a" )
        _populate_3DCore_target_properties(DEBUG "libQt53DCored.a" "" )
    endif()
