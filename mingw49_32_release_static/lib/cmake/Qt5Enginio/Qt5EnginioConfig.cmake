...
if (NOT TARGET Qt5::Enginio)
    ...
    set(Qt5Enginio_PRIVATE_INCLUDE_DIRS
        "${_qt5Enginio_install_prefix}/include/Enginio/1.6.3"
        "${_qt5Enginio_install_prefix}/include/Enginio/1.6.3/Enginio"
    )
    ...
    if (EXISTS "${_qt5Enginio_install_prefix}/lib/libQt5Enginiod.a" )
        _populate_Enginio_target_properties(DEBUG "libQt5Enginiod.a" "" )
    endif()
