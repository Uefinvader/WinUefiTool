...
set(Qt53DQuick_VERSION_STRING 5.6.3)
...
if (NOT TARGET Qt5::3DQuick)
    ...
    set(Qt53DQuick_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuick_install_prefix}/include/Qt3DQuick/5.6.3"
        "${_qt53DQuick_install_prefix}/include/Qt3DQuick/5.6.3/Qt3DQuick"
    )
    ...
    foreach(_module_dep ${_Qt53DQuick_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.6.3 ${_Qt53DQuick_FIND_VERSION_EXACT}
    ...
    if (EXISTS "${_qt53DQuick_install_prefix}/lib/libQt53DQuickd.a" )
        _populate_3DQuick_target_properties(DEBUG "libQt53DQuickd.a" "" )
    endif()
